...
mysql_select_db($database_conexao, $conexao);
$query_total_geral = sprintf("SELECT SUM(valor) as total FROM movimento WHERE mes = %s and tipo =1", GetSQLValueString($colname_total_geral, "text"));
...
$totalRows_total_geral = mysql_num_rows($total_geral);
        ...
        <form name="form2" method="post" action="despesas2.php">
        <label>
     ...
     $sql = "SELECT * from movimento WHERE mes = '".$_SESSION['MM_Username']."' AND tipo='1' AND status = '1'  AND 
        ...
        <td valign="top" class="td"><font color="#333"><?php echo $resultado['cliente']; ?></font></td>
        
        <td valign="top"  class="td"><font color="#333"><?php echo $resultado['descricao']; ?></td>
        <td valign="top"  class="td" align="center"><font color="#333"><?php 
        ...
        echo "<a class=\"pag\" href='despesas2.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='despesas2.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='despesas2.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
