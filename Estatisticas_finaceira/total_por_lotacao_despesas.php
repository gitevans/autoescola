...
$query_total = "SELECT SUM( mov.valor ) AS valor, ac.filial FROM acesso AS ac, movimento AS mov WHERE ac.nome = mov.id_cliente and mov.tipo='1' GROUP BY ac.filial";
...
<table width="1000" border="0" align="center" style="border-collapse:collapse;">
  ...
  <tr>
    <td width="836" bgcolor="#666"><span class="style1 td">Total de despesas por lota&ccedil;&atilde;o</span><br /></td>
