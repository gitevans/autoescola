...
$query_cliente = sprintf("SELECT * FROM calendar_events1 WHERE id = %s", GetSQLValueString($colname_cliente, "int"));
...
<p>Instrutor : <?php echo $row_cliente['instrutor']; ?><br />
  Veiculo:  <?php echo $row_cliente['veiculo']; ?></p>
<p>Categoria: <?php echo $row_cliente['categoria']; ?><br />
   Tipo:  <?php echo $row_cliente['tipo']; ?></p>
Observação: <?php echo $row_cliente['descricao']; ?></p>
<?php
