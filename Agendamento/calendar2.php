        ...
        $event_title .= stripslashes("<a class=\"nome\" href=\"javascript:abrir('cliente2.php?id=".$ev["id"]."');\">".$ev["aluno"]."</a>")."<br/> ";
        ...
        echo "<td valign=\"top\"><a class=\"alink\" href=\"eventos3.php?m=".$month."&d=".$dayArray["mday"]."&y=$year;\">"."<span class\"alink\">".$dayArray["mday"]."</span>"."<span class=\"numero\"><font color\"Red\">Reservar</font></span> "."</a><br/></br>"."<span class=\"nome\"><font color\"Red\">".$event_title."</td>\n"."</font></span>";
