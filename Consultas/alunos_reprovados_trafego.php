...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="consulta_reprovados_trafego.php">
			<label>
			...
			<input class="bt2" type="submit" name="button" id="button" value="Pesquisar">
			  ...
			  ALUNOS REPROVADOS NO EXAME DE TR&Aacute;FEGO
			</form>
			</td>
			</tr>
			</table>
     ...
     $sql = "SELECT * from trafego WHERE status='2' and aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_trafego.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_trafego.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
