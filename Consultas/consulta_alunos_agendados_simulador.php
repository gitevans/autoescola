...
$query_contar = "SELECT count( *) FROM calendar_events1";
...
$totalRows_contar = mysql_num_rows($contar);
			...
			if($_POST["chkDel"][$i] != "")
			{
			$strSQL = "DELETE FROM calendar_events1 ";
...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="alunos_agendados_simulador2.php">
			<label>
...
Alunos</td>
			...
			$sql = "SELECT * from calendar_events1  WHERE mes like '".$filtro."%' AND instrutor like '".$filtro1."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
	   ...
	   ?></td>
			...
			<tr><?php $cont ++; }?>
			<?php
			$sql_select_all = "select * from calendar_events1 ";
			...
			echo "<a class=\"pag\" href='alunos_agendados_simulador2.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='alunos_agendados_simulador2.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='alunos_agendados_simulador2.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
