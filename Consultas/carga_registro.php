...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO carga_legislacao (aluno, qtd, hora) VALUES (%s, %s, %s)",
...
mysql_select_db($database_conexao, $conexao);
$query_cads = sprintf("SELECT * FROM carga WHERE id = %s", GetSQLValueString($colname_cads, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="hidden" name="aluno" value="<?php echo $row_cads['aluno']; ?>" size="32" />
      <?php echo $row_cads['aluno']; ?></td>
    </tr>
    <tr valign="baseline">
