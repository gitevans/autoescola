...
$query_carga_t = "SELECT SUM(hora) FROM carga_trafego";
...
mysql_select_db($database_conexao, $conexao);
$query_soma = "select SUM(qtd) from carga_trafego";
...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="adicionar_carga_trafego.php">
			<label>
     ...
     $sql = "SELECT DISTINCT id,aluno,qtd,hora from carga1 order by id DESC";
...
?> 
        ...
        <td align="left" valign="top"  class="td style1"><div align="center"><a href="#" onclick="MM_openBrWindow('carga_registro2.php?id=<?php echo $resultado['id']; ?>','','scrollbars=yes,resizable=yes,width=300,height=150')">Registrar</a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
        <?php
        ...
        echo "<a class=\"pag\" href='adicionar_carga_trafego.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='adicionar_carga_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='adicionar_carga_trafego.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
...
<?php 
			...
			$op="Registrar carga (aula prática) !";
