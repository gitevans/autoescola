...
-->
			...
			<form name="form2" method="post" action="adicionar_carga_pratica.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;Cargar hor&aacute;ria do aluno em rela&ccedil;&atilde;o as aulas Pr&aacute;tica
			</form>
			</td>
			</tr>
			</table>
...
?> 
        ...
        echo "<a class=\"pag\" href='adicionar_carga_pratica.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='adicionar_carga_pratica.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='adicionar_carga_pratica.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
