...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="../home/index.php">
			<label>
			...
			<table width="750" border="1" align="center" bordercolor="#333" class="td2" style="border-collapse:collapse;">
			...
			$sql = "SELECT * from calendar_events  WHERE 
			event_start='$dat' AND aluno like '".$filtro."%' AND instrutor like '".$filtro1."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
			...
			$max_links = 3;
			?>
			<td colspan="5" align="center"  bgcolor="#333" valign="top"><br />
			
			<?php
			
			echo "<a class=\"pag\" href='../home/index.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='../home/index.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='../home/index.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
