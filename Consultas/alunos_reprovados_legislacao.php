			...
			<form name="form2" method="post" action="consulta_reprovados_legislacao.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;ALUNOS REPROVADOS NO EXAME DE LEGISLA&Ccedil;&Atilde;O
			</form>
			</td>
			</tr>
			</table>
     ...
     $sql = "SELECT * from legislacao WHERE status='2' and aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_legislacao.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_legislacao.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='consulta_reprovados_legislacao.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
        ...
        ?><br />
			...
			$op="Registrou alunos reprovados !";
