...
?> 
        ...
        <td align="left" valign="top"  class="td style1"><div align="center"><a href="#" onclick="MM_openBrWindow('registrar_legislacao.php?id=<?php echo $resultado['id']; ?>','','scrollbars=yes,resizable=yes,width=300,height=150')"><img src="../Img/BTS.jpg" /></a></div></td>
        </tr>
        <tr><?php $cont ++; }?>
        <?php
