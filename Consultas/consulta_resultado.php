...
<td width="225" valign="top" bgcolor="#FFFFFF"><span class="style6">CATEGORIA<br />
    ...
    <td width="268" valign="top" bgcolor="#FFFFFF"><span class="style6">DESCRI&Ccedil;&Atilde;O</span></td>
  ...
  <tr bgcolor="<?php echo $cor ; ?>">
    ...
    <td valign="top" bgcolor="#FFFFFF" class="style11"><?php echo $row_movei['descricao']; ?></td>
