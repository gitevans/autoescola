...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="adicionar_trafego.php">
			<label>
			...
			<td width="293" valign="top" bgcolor="#333333" class="td" ><br />
			  aluno</td>
			<td width="217"  valign="top" bgcolor="#333333" class="td" ><br />
			email</td>
			<td width="110"  valign="top" bgcolor="#333333" class="td"><br />
			telefone</td>
			<td width="217" align="center" valign="top" bgcolor="#333333" class="td"><br />
			Exame</div></td>
			</tr>
			<?php
			...
			<td valign="top" class="td3" align="center"><a href="#" onclick="MM_openBrWindow('trafego.php?id_aluno=<?php echo $resultado['id_aluno'] ?>','','scrollbars=yes,resizable=yes,width=400,height=300')"><img src="../Img/trafego.jpg" /></a></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='adicionar_trafego.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='adicionar_trafego.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='adicionar_trafego.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
