...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="consulta_admin.php">
			<label>
			...
			<td valign="top" class="td3"><div align="center"><a href="../Cadastros/servicos.php?id_aluno=<?php echo $resultado[id_aluno]; ?>"><img src="../Img/SERV.jpg" /></a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			$op="Cadastrou um novo Servico ao aluno!";
