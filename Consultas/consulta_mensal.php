	...
	<div id="topo">
	<div class="texto style3"><span class="style16">CONTROLE FINANCEIRO</span> fluxo de caixa<br />
	<br />
	<br />
	</div>
	</div>
	...
	<fieldset><legend>Consultas por M&ecirc;s</legend>
	...
	<br />
	<br />
	<input name="button" type="submit" class="bt4" id="button" value="CONSULTAR" />
	</form>
