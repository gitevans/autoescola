...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="prova_legislacao2.php">
			<label>
			...
			&nbsp; &nbsp; &nbsp;Exame de legisla&ccedil;&atilde;o
			</form>
			</td>
			</tr>
			</table>
     ...
     $sql = "SELECT * from legislacao WHERE aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
        ...
        echo "<a class=\"pag\" href='prova_legislacao2.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='prova_legislacao2.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='prova_legislacao2.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
