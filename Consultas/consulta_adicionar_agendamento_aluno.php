...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<li><a href="../Cadastros/cadastro_alunos.php">Cadastro</a></li>
			<li><a href="../Consultas/consulta_alunos.php">Consultas </a></li>
			<li><a href="<?php echo $logoutAction ?>">Sair</a></li>
			<li><a href="../Consultas/consulta_alunos.php">Usuário Logado &raquo; &raquo; <?php echo $_SESSION['MM_Username']; ?></a></li>
			</ul>
			</nav>
			<br>
			<br>
			...
			<table width="1000" border="1" align="center" bordercolor="#FF9900" class="td2" style="border-collapse:collapse;">
			</tr>
			<tr>
			<td colspan="6" bgcolor="#8b4a10"><strong><font color="#FFFFFF">CONSULTAS DE OPERAÇÕES</font></strong></td>
			</tr>
			<tr>
			...
			<td valign="top"><?php echo $resultado['nome']; ?></td>
			
			<td valign="top"><?php echo $resultado['endereco']; ?></td>
			<td valign="top"><?php echo $resultado['telefone']; ?></td>
			<td valign="top"><?php echo $resultado['email']; ?></td>
			<td valign="top"><div align="center"><a href="../Agendamento/calendar.php?id_aluno=<?php echo $resultado[id_aluno]; ?>">Agendar</a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			$max_links = 3;
			?>
			<td colspan="6" align="center"  bgcolor="#ff9900" valign="top"><br />
