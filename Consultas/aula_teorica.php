			...
			<form name="form2" method="post" action="aula_teorica2.php">
			<label>
			...
			<td valign="top" class="td3"><div align="center"><a href="#" onclick="MM_openBrWindow('../Cadastros/turma.php?id_aluno=<?php echo $resultado['id_aluno']; ?>','','scrollbars=yes,resizable=yes,width=550,height=300')"><img src="../Img/sala.jpg" /></a></div></td>
			</tr>
			<tr><?php $cont ++; }?>
			<?php
			...
			echo "<a class=\"pag\" href='aula_teorica2.php?p=1' target='_self'><span class=\"\">&laquo; Anterior</span></a> ";
			...
			echo "<a class=\"pag\" href='aula_teorica2.php?p=".$i."' target='_self'>".$i."</a> ";
			}
			}
			...
			echo "<a class=\"pag\" href='aula_teorica2.php?p= " .$pags."' target='_self'><span class=\"\">Pr&oacute;xima &raquo;</span></a> ";
