...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="consulta_aluno_aprovado.php">
			<label>
			...
			<input class="bt2" type="submit" name="button" id="button" value="Pesquisar">
			  ...
			  Situa&ccedil;&atilde;o do aluno em rela&ccedil;&atilde;o ao exame de tr&aacute;fego
			</form>
			</td>
			</tr>
			</table>
     ...
     $sql = "SELECT * from trafego order by id DESC";
        ...
        <td valign="top"  class="td" align="left"><font color="#666666"><a href="#" 
        onclick="MM_openBrWindow('editar_estatus.php?id=<?php echo $resultado['id'] ?>','','scrollbars=yes,resizable=yes,width=300,height=180')">
	<?php if($resultado['status'] == 1){
        ...
        echo "<a class=\"pag\" href='consulta_aluno_aprovado.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='consulta_aluno_aprovado.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='consulta_aluno_aprovado.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
        ...
        ?><br />
			...
			$op="Consultou Situação do aluno em relação ao exame de tráfego !";
