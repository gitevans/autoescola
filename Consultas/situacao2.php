...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="consulta_redimento_legislacao.php">
			<label>
     ...
     $sql = "SELECT * from legislacao WHERE aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
        ...
        echo "<a class=\"pag\" href='consulta_redimento_legislacao.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='consulta_redimento_legislacao.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='consulta_redimento_legislacao.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
        ...
        ?><br />
			...
			$op=" ConsultOU SITUAÇÃO DO ALUNO EM RELAÇÃO AO EXAME DE LEGISLAÇÃO !";
