...
<div class="container-fluid">
	<div class="row-fluid"> 
			...
			<form name="form2" method="post" action="prova_trafego2.php">
			<label>
     ...
     $sql = "SELECT * from trafego WHERE aluno like '".$filtro."%' ORDER BY id DESC LIMIT $inicio, $qnt ";
        ...
        echo "<a class=\"pag\" href='prova_trafego2.php?p=1' target='_self'>&laquo; Anterior</a> ";
        ...
        echo "<a class=\"pag\" href='prova_trafego2.php?p=".$i."' target='_self'>".$i."</a> ";
        }
        }
        ...
        echo "<a class=\"pag\" href='prova_trafego2.php?p= " .$pags."' target='_self'>Pr&oacute;xima &raquo;</a> ";
